...
def main(
    ...
    log.info(f"Starting training with official config:\n{pprint.pformat(params_log_info)}")
    ...
    log_name = os.path.join(task, "td3", str(seed), now)
    ...
    def save_best_fn(policy: Algorithm) -> None:
        ...
        log.info(f"Saved best policy to {log_path}/best_policy.pth")

    # 开始训练
    if not watch:
        log.info("Starting TD3 training...")
