...
```bash
python3 vizdoom_c51.py --num_test_envs 100 --resume-path 10pri_policy.pth --watch --task {D1_basic|D3_battle|D4_battle2}
```

To save `.lmp` files for recording:

```bash
python3 vizdoom_c51.py --save-lmp --num_test_envs 100 --resume-path 10pri_policy.pth --watch --task {D1_basic|D3_battle|D4_battle2}
```
